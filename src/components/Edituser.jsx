...
const Edituser = () => {
    ...
    return (
        <div className="p-6 max-w-lg mx-auto border rounded shadow-md mt-10">
            <h2 className="text-2xl font-bold mb-4 text-center">Edit User</h2>
            <button onClick={() => { navigate('/home') }} className='border py-1 px-3 bg-white text-black rounded-sm mb-2'>Back</button>
